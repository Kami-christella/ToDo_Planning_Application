...
{/* <FaRegMessage className='cart' href='blog.jsx'/>   */}
{/* <FaRegMessage className="cart" onClick={() => navigate('/Cart')} style={{ cursor: 'pointer' }} /> */}
    ...
    <button className="dropbtn2">Plan Your Day Application </button> 
